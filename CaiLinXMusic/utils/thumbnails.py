...
async def get_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("CaiLinXMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("CaiLinXMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("CaiLinXMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("CaiLinXMusic/assets/play_icons.png")
