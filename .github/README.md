...
- Get your [Necessary Variables](https://github.com/sasuke-music-v2/CaiLinXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/sasuke-music-v2/CaiLinXMusic && cd CaiLinXMusic
   ```
